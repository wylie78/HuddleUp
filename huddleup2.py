...
def add_list():
	...
	if request.form['text']:
		db.session.add(List(u.username, u.enter, request.form['text'], int(time.time())))
		db.session.commit()
...
def add_task(list_id):
	...
	if request.form['text']:
		db.session.add(Task(u.username, list_id, request.form['text'], int(time.time())))
		db.session.commit()
